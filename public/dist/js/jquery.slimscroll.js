...
{var offset=me.scrollTop();bar=me.closest('.'+o.barClass);rail=me.closest('.'+o.railClass);getBarHeight();if($.isPlainObject(options))
...
lastScroll=percentScroll;if(barHeight>=me.outerHeight()){bar.hide();releaseScroll=!0;return}
