...
<meta charset="UTF-8" />
    ...
    <meta name="description" content="Libot Philippines - Feedback for {{ $user->first_name }}" />
    <meta name="keywords" content="libot, libot philippines, travel, libot travel, rent, feedback, reviews, Feedback for {{ $user->first_name }}" />
